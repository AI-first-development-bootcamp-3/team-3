...
const PROJECTS: Array<{
  ...
  { id: IDS.projectCuda, name: 'CUDA Runtime', clientId: IDS.nvidia, isActive: true, reportFormat: 'CLOCK_IN_OUT' },
  { id: IDS.projectOmniverse, name: 'Omniverse Hub', clientId: IDS.nvidia, isActive: true, reportFormat: 'SUM_HOURS' },
  { id: IDS.projectMeteor, name: 'Meteor Lake Tools', clientId: IDS.intel, isActive: true, reportFormat: 'CLOCK_IN_OUT' },
  { id: IDS.projectArc, name: 'Arc Drivers', clientId: IDS.intel, isActive: true, reportFormat: 'SUM_HOURS' },
  { id: IDS.projectRocm, name: 'ROCm Platform', clientId: IDS.amd, isActive: true, reportFormat: 'CLOCK_IN_OUT' },
  { id: IDS.projectRyzenAi, name: 'Ryzen AI', clientId: IDS.amd, isActive: true, reportFormat: 'SUM_HOURS' },
  { id: IDS.projectPrintCloud, name: 'Print Cloud', clientId: IDS.hp, isActive: true, reportFormat: 'CLOCK_IN_OUT' },
  { id: IDS.projectElitebook, name: 'EliteBook Firmware', clientId: IDS.hp, isActive: true, reportFormat: 'CLOCK_IN_OUT' },
  { id: IDS.projectAlexa, name: 'Alexa Skills', clientId: IDS.amazon, isActive: true, reportFormat: 'SUM_HOURS' },
  { id: IDS.projectAwsConsole, name: 'AWS Console IL', clientId: IDS.amazon, isActive: true, reportFormat: 'CLOCK_IN_OUT' },
];
